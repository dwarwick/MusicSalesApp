...
public interface IAccountEmailService
{
    ...
    /// <param name="baseUrl">The base URL for constructing asset URLs.</param>
    /// <returns>True if the email was sent successfully, false otherwise.</returns>
    Task<bool> SendPasswordChangedEmailAsync(string userEmail, string userName, string? timeZoneId, string baseUrl);
    ...
    /// <param name="baseUrl">The base URL for constructing asset URLs.</param>
    /// <returns>True if the email was sent successfully, false otherwise.</returns>
    Task<bool> SendSubscriptionCancelledEmailAsync(string userEmail, string userName, DateTime? endDate, string? billingSource, string? timeZoneId, string baseUrl);
