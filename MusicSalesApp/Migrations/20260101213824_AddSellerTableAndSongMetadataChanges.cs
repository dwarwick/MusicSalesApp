...
namespace MusicSalesApp.Migrations
{
    ...
    public partial class AddSellerTableAndSongMetadataChanges : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //    values: new object[] { 7, "Permission", "ValidatedUser", 2 });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { 4, "c3d4e5f6-a7b8-6c7d-0e1f-2a3b4c5d6e7f", "Seller", "SELLER" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 7, "Permission", "ValidatedUser", 4 },
                    { 8, "Permission", "UploadFiles", 4 },
                    { 9, "Permission", "ManageOwnSongs", 4 }
                });
