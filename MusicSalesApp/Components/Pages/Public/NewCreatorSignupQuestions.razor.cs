...
public partial class NewCreatorSignupQuestionsModel : BlazorBase
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        catch (Exception ex) when (CircuitTeardown.IsExpected(ex))
        {
            ...
            Logger.LogDebug(ex, "Error loading new creator signup questions page data");
        }
        catch (Exception ex)
        {
            Logger.LogError(ex, "Error loading new creator signup questions page data");
        }
    }
