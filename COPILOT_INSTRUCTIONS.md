...
#### Song MP3 (with cover image)
**Identification:**
- MP3 file
- Has associated JPEG cover image
...
```csharp
// All songs are standalone songs with cover images
var hasCoverImage = !string.IsNullOrEmpty(song.JpegFileName) || _songImageFile != null;

// Validate: song cover image, genre
if (!hasCoverImage) {
    // Error: Song cover image required
}
...
When saving changes, save to SQL database:
